...
public class StudentStack {
    ...
    void loadData(int k) {
        String[] a = Lib.readLineToStrArray("data3.txt", k);
        String[] b = Lib.readLineToStrArray("data3.txt", k + 1);
        String[] c = Lib.readLineToStrArray("data3.txt", k + 2);
        String[] d = Lib.readLineToStrArray("data3.txt", k + 3);
        int n = a.length;
        for (int i = 0; i < n; i++) {
